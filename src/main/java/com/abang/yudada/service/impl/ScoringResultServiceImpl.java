package com.abang.yudada.service.impl;
...
import com.abang.yudada.constant.CommonConstant;
import com.abang.yudada.exception.ThrowUtils;
import com.abang.yudada.mapper.ScoringResultMapper;
import com.abang.yudada.model.dto.scoringResult.ScoringResultQueryRequest;
import com.abang.yudada.model.entity.ScoringResult;
import com.abang.yudada.model.entity.User;
import com.abang.yudada.model.vo.ScoringResultVO;
import com.abang.yudada.model.vo.UserVO;
import com.abang.yudada.service.ScoringResultService;
import com.abang.yudada.service.UserService;
import com.abang.yudada.utils.SqlUtils;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public QueryWrapper<ScoringResult> getQueryWrapper(ScoringResultQueryRequest scoringResultQueryRequest) {
        ...
        queryWrapper.like(StringUtils.isNotBlank(resultDesc), "resultProp", resultDesc);
        ...
        queryWrapper.ne(ObjectUtils.isNotEmpty(resultScoreRange), "resultScoreRange", resultScoreRange);
