...
import com.abang.yudada.model.enums.AppScoringStrategyEnum;
...
import com.abang.yudada.mapper.AppMapper;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 80, ErrorCode.PARAMS_ERROR, "标题过长,要大于80");
        }
