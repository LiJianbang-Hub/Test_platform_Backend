...
import com.abang.yudada.common.ReviewRequest;
...
import com.abang.yudada.model.dto.app.AppAddRequest;
import com.abang.yudada.model.dto.app.AppEditRequest;
import com.abang.yudada.model.dto.app.AppQueryRequest;
import com.abang.yudada.model.dto.app.AppUpdateRequest;
...
public class AppController {
     ...
     * @param appAddRequest
     * @param request
     * @return@RequestBody AppAddRequest appAddRequest：从HTTP请求体中获取AppAddRequest对象，它包含了创建应用所需的数据
     * HttpServletRequest request：提供了对HTTP请求的访问，可以用来获取如登录用户等信息。
     */
    @PostMapping("/add")
